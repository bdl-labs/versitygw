...
[* BurnBridge Backend](#burnbridge-backend)<br>
...
* secure, burnbridge backend, with static buckets
* secure, burnbridge backend, with creation/removal of buckets
...
**BACKEND**:  the storage backend type for the gateway, normally **burnbridge** in this build.

**LOCAL_FOLDER**:  local folder used for bridge test metadata and temporary files.
